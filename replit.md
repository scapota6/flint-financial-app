...
-   **Financial Goals System**: User-defined goals for debt payoff, savings, and emergency fund tracking. Features include:
    ...
    - **Smart Emergency Fund Tracking (Dec 2025)**: Emergency fund goals work identically to savings goals - they require selecting a linked bank account, capture the starting balance, and track progress using the same formula. This allows users to designate which of their connected accounts is their emergency fund and set a target balance goal.
