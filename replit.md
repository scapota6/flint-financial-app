...
- **Styling**: Apple 2025 "Liquid Glass" aesthetic with deep dark neutrals (#0B0D11), translucent glass surfaces (rgba(24, 27, 31, 0.55) with 16px blur), Tailwind CSS utilities, Radix UI via shadcn/ui, Inter font stack. Complete design system includes glass components, comprehensive typography hierarchy (responsive headings, gradient text, stat numbers, pricing), Apple color palette (blue #0A84FF, teal #64D2FF, green #34C759, red #FF3B30, yellow #FFD60A), and mobile-responsive adjustments. Text uses #F2F4F6 (primary) and #A7ADBA (secondary) for optimal readability.
- **UI/UX Decisions**: Fixed top navigation, animated link glows, responsive three-column account grid, full-screen modals, interactive micro-animations, consistent Apple blue accent, accessibility features, liquid glass card aesthetics throughout.
