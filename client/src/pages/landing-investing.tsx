      ...
      <div className="min-h-screen bg-[#F4F2ED] overflow-x-hidden">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
              <div className="bg-white rounded-xl border border-gray-200 p-4 md:p-6 shadow-sm">
                <h3 className="text-base md:text-lg font-semibold mb-2 text-gray-900">Unified Portfolio</h3>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-4 md:p-6 shadow-sm">
                <h3 className="text-base md:text-lg font-semibold mb-2 text-gray-900">Track Performance</h3>
                <p className="text-gray-500 text-sm">
              ...
              <div className="bg-gradient-to-b from-blue-50 to-white rounded-xl border border-blue-200 p-4 md:p-6 shadow-sm">
                <h3 className="text-base md:text-lg font-semibold mb-2 text-gray-900">Trade from Flint</h3>
                <p className="text-gray-500 text-sm">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row w-full gap-8">
              <div className="flex-1 flex flex-col items-center text-center group">
                <div className="relative mb-6">
                  ...
                  <div className="relative bg-white border border-gray-200 rounded-2xl h-20 w-20 flex flex-col justify-center items-center shadow-lg">
                    <LineChart className="h-6 w-6 text-amber-500 mb-1" />
                ...
                <p className="text-gray-600">
                  Link Robinhood, Schwab, Fidelity, E*TRADE, and 50+ more in seconds.
                </p>
              </div>
              ...
              <div className="flex-1 flex flex-col items-center text-center group">
                ...
                <p className="text-gray-600">
                  View all your positions, track performance, and see your total value update in real time.
                </p>
              </div>
              ...
              <div className="flex-1 flex flex-col items-center text-center group">
                ...
                <h3 className="font-semibold text-xl mb-2 text-gray-900">Trade</h3>
                <p className="text-gray-600">
                  Set price alerts, track dividends, and place trades without switching apps.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 bg-[#F4F2ED]">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="font-serif text-2xl md:text-3xl mb-4 text-gray-900">Ready to simplify your investing?</h2>
          ...
          <div className="w-full max-w-3xl mx-auto">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="1" className="border-b border-gray-300">
                <AccordionTrigger className="text-left hover:no-underline text-gray-900 py-4 font-medium">Is my data safe?</AccordionTrigger>
              ...
              <AccordionItem value="2" className="border-b border-gray-300">
                <AccordionTrigger className="text-left hover:no-underline text-gray-900 py-4 font-medium">Which brokerages do you support?</AccordionTrigger>
                <AccordionContent className="text-gray-600 pb-4">
              ...
              <AccordionItem value="3" className="border-b border-gray-300">
                <AccordionTrigger className="text-left hover:no-underline text-gray-900 py-4 font-medium">Can I trade from Flint?</AccordionTrigger>
                <AccordionContent className="text-gray-600 pb-4">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-500">
                  Track all your investments in one secure platform.
                </p>
              </div>
