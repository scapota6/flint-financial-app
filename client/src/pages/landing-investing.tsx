      ...
      <div className="min-h-screen bg-[#F4F2ED] overflow-x-hidden">
        ...
        <section className="pt-28 pb-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-yellow-400/20 border border-yellow-400/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm text-yellow-700">Stock Portfolio Tracker</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold font-serif mb-6 leading-tight text-gray-900">
              All Your <span className="relative inline-block">Investment Apps<span className="absolute bottom-1 left-0 w-full h-2 bg-yellow-400 -z-10"></span></span> in One Place
            </h1>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                <p className="text-3xl font-bold text-yellow-600 mb-2">Trade</p>
        ...
        <section id="features" className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold font-serif text-center mb-4 text-gray-900">Why Investors Love Flint</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-gradient-to-b from-yellow-50 to-white rounded-xl border border-yellow-200 p-6 shadow-sm">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-10">
              <div className="flex items-start gap-6">
                <span className="text-4xl font-black text-yellow-500 flex-shrink-0">1</span>
                <div>
              ...
              <div className="flex items-start gap-6">
                <span className="text-4xl font-black text-yellow-500 flex-shrink-0">2</span>
                <div>
              ...
              <div className="flex items-start gap-6">
                <span className="text-4xl font-black text-yellow-500 flex-shrink-0">3</span>
                <div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold font-serif mb-4 text-gray-900">Ready to simplify your investing?</h2>
        ...
        <section id="pricing" className="py-20 px-4 bg-white border-y border-gray-200">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-[#F4F2ED] rounded-xl border border-gray-200 p-6 h-full flex flex-col">
                <div className="mb-6">
              ...
              <div className="bg-gradient-to-b from-yellow-50 to-white rounded-xl border border-yellow-300 p-6 h-full flex flex-col relative shadow-lg">
